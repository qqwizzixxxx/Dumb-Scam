...
local suskey = "HVfJklJ77t6677tu7ti7i67F7TIIFTY67fsefVHhuhHGGJhj87GJRbxS@Susi9Cum"
...
VerifyButton.MouseButton1Down:connect(function()
	if KeyBox.Text == suskey then
		...
		wait(1)
Notification:Notify(
    {Title = "Correct", Description = "You Key Correct"},
...
GetKey.MouseButton1Down:connect(function()
	setclipboard("https://discord.gg/vRcdTdUgkB")
	
	wait(1)
Notification:Notify(
    {Title = "Link Copied", Description = "Key Link Copied To You ClipBoard"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "default"}
)
end)
...
GuiRemoval.MouseButton1Down:connect(function()
	...
	wait(1)
Notification:Notify(
    {Title = "Bruh Dude", Description = "Key Not Correct"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "default"}
)
end)
